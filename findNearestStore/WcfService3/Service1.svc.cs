...
namespace WcfService3
{
    ...
    {
        public String[] findNearestStore(string zip,string storeN)
        {

            String url = "https://maps.googleapis.com/maps/api/place/textsearch/xml?query="+storeN+"+in+" + zip +
